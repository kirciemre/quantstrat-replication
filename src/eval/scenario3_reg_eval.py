...
cfg = load_config("configs/scenario3_reg.yaml")
...
# --- scatter: chosen inventory vs signal (compare to paper Fig 13c reg-DDPG) ---
...
plt.title("Policy: inventory vs signal (compare to paper Fig 13b)")
plt.tight_layout()
plt.savefig("policy_scatter_scenario3_reg.png", dpi=130)
plt.close()
...
np.save(
    f"artifacts/rewards_scenario{cfg.scenario}_reg.npy",
    episode_rewards,
)
